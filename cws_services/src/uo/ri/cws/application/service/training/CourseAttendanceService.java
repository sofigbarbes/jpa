...
public interface CourseAttendanceService {
	 ...
	 *                           another enrollment registered for the same
	 *                           mechanic and course, or - the attendance is
	 *                           under 85% and the course is marked as passed,
	 *                           or - the course is not yet finished, or <-
	 *                           IGNORE THIS, complicates testing - the value
	 *                           for percentage is not in the range 0..100
	 */
