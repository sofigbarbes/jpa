...
public interface AssignWorkOrderService {
	 ...
	 * today/next. Only work orders with OPEN status can be assigned. Work
	 * orders changes to ASSIGNED status when assigned.
	 *
	 * @param woId,       the work order id
	 * @param mechanicId, the mechanic one
	 *
	 * @throws BusinessException if: - the mechanic does not exist, or - the
	 *                           work order does not exist, or - the work order
	 ...
	 * workOrder. Every certificate includes full mechanic data (@see
	 * MechanicDto).
	 *
