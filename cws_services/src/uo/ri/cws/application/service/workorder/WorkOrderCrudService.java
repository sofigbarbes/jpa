...
public interface WorkOrderCrudService {
	 ...
	 * will be taken into account: - the vehicle id, and - the description of
	 * the work to be done The rest of fields will assigned by the service, thus
	 * any provided value will be ignored.
	 *
	 ...
	 *                           vehicle at the same date and time (timestamp),
	 *                           or - the vehicle does not exist
	 */
	 ...
	 * fields. No other field is taken for the update. Only work orders with
	 * status of OPEN or ASSIGNED can be updated.
	 *
	 ...
	 *                           (optimistic lock), or - the work order is not
	 *                           in the OPEN or ASSIGNED status
	 */
	 ...
	 * 
	 * @param id
	 * @return the list, will be empty if: - the vehicle does not exist, or - it
	 *         has no work orders registered.
