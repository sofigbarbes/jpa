...
public class Invoice extends BaseEntity {
	...
	/**
	 * Computed amount and vat (vat depends on the date) Total amount will be the
	 * addition of all work order amounts plus VAT. VAT depends on the date in which
	 * the invoice was generated: if it is before 1/7/2012, 18% will apply,
	 * thereafter 21%
	 */
